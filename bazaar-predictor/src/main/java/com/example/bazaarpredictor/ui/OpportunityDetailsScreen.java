...
public final class OpportunityDetailsScreen extends Screen {
    ...
    @Override protected void init() {
        addRenderableWidget(Button.builder(Component.literal("Prepare order"), b -> minecraft.setScreenAndShow(new ConfirmationScreen(opportunity))).bounds(width / 2 - 105, height / 2 + 60, 210, 20).build());
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float delta) {
        ...
        text(g, "Review the values, then confirm manually.", x, y + 122, 0xFFCC66); super.extractRenderState(g, mouseX, mouseY, delta);
    }
